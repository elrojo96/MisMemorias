//
//  ViewControllerAgregarFotografiaFamilia.swift
//  ProyectoFinalBueno
//
...
class ViewControllerAgregarFotografiaFamilia: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
        ...
        @IBAction func btGuardar(_ sender: UIButton)
        {
            ...
            {
                let fotoTemporal = FotografiaFamilia()

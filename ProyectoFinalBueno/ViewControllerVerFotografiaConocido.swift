//
//  ViewControllerVerFotografiaConocido.swift
//  ProyectoFinalBueno
//
...
class ViewControllerVerFotografiaConocido: UIViewController {
    ...
    */
    ...
    @IBAction func eliminarFotografia(_ sender: UIButton)
    {
        ...
        try! realm.write {
            let fotoParaEliminar = realm.objects(FotografiaConocido.self).filter("imagen == %@", Imagen)

//
//  ViewControllerAgregarFotografiaAAlbumFamiliar.swift
//  ProyectoFinalBueno
//
...
protocol ProtocoloRecargaVista
{
    func recargaVista() -> Void
}

class ViewControllerAgregarFotografiaAAlbumFamiliar: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBAction func btGuardar(_ sender: UIButton)
    {
        ...
        {
            let fotoTemporal = FotografiaFamiliaDeUnAlbum()

//
//  ViewControllerVerFotografiaDeAlbum.swift
//  ProyectoFinalBueno
//
//  Created by Luis Alfonso Rojo Sánchez on 13/11/17.
...
class ViewControllerVerFotografiaDeAlbum: UIViewController {
    ...
    */
    ...
    @IBAction func eliminarFotografia(_ sender: UIButton)
    {
        ...
        try! realm.write {
            let fotoParaEliminar = realm.objects(FotografiaFamiliaDeUnAlbum.self).filter("imagen == %@", Imagen)

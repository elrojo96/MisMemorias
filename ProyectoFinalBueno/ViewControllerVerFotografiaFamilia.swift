//
//  ViewControllerVerFotografiaFamilia.swift
//  ProyectoFinalBueno
//
...
class ViewControllerVerFotografiaFamilia: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        //Funcion para mostrar modal con la imagen seleccionada.
    ...
    */
    ...
    @IBAction func eliminarFotografia(_ sender: UIButton)
    {
        ...
        try! realm.write {
            let fotoParaEliminar = realm.objects(FotografiaFamilia.self).filter("imagen == %@", Imagen)

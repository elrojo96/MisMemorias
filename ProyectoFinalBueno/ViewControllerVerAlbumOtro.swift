//
//  ViewControllerVerAlbumOtro.swift
//  ProyectoFinalBueno
//
...
class ViewControllerVerAlbumOtro: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, ProtocoloRecargaVista {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        {
            let vistaAgregarFotografia = segue.destination as! ViewControllerAgregarFotografiaAAlbumOtro
        ...
        else if segue.identifier == "mostrarFotografia"
        {
            ...
            let vistaVerDetalle = segue.destination as! ViewControllerVerFotografiaDeAlbum2
    ...
    @IBAction func unwindAgregarFotografiaParaAlbumOtro(unwindSegue : UIStoryboardSegue)
    {
        Nombre.removeAll()
        Relacion.removeAll()
        Fecha.removeAll()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier2, for: indexPath) as! CollectionViewCellFotografiaDeUnAlbumOtro
    ...
    func queryImages(){
        ...
        let allImages = realm.objects(FotografiaOtroDeUnAlbum.self).filter("albumPerteneciente == %@", nombreDelAlbum)
